...
describe.skipIf(!existsSync(CJS_DIST))("react-scan/lite SSR safety (built CJS in node -e)", () => {
...
describe.skipIf(!existsSync(ESM_DIST))("react-scan/lite SSR safety (built ESM in node -e)", () => {
