...
import {
  ...
  signalNotificationDismissed,
  signalNotificationsOpen,
  signalRefWidget,
  signalSettingsOpen,
  signalWidget,
  updateDimensions,
...
export const Widget = () => {
  ...
  return (
    <>
      <ScanOverlay />
      {/* this technically is not reactive, but is fine it should work */}
          ...
          >
            ...
            >
              {Store.inspectState.value.kind === 'focused' &&
                !signalNotificationsOpen.value && <Header />}
              <div
                className={cn(
                  'relative',
                  'flex-1 flex',
...
export const Logo = ({ size = 24, color = '#A284F5' }) => {
  return (
    <svg
